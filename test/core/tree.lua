...
test[#test + 1] = function()
    ...
    assert(2 == #(t:get_successors(t.root)))
    assert(2 == #(t:get_successors(a)))
    assert(1 == #(t:get_successors(b)))
    assert(1 == #(t:get_successors(c)))
    assert(3 == #(t:get_successors(d)))
    assert(1 == #(t:get_successors(e)))
    assert(not t:has_successors(f))
    assert(0 == #(t:get_successors(f)))
    assert(not t:has_successors(g))
    assert(0 == #(t:get_successors(g)))
    assert(not t:has_successors(h))
    assert(0 == #(t:get_successors(h)))
    assert(not t:has_successors(i))
    assert(0 == #(t:get_successors(i)))
    assert(not t:has_successors(j))
    assert(0 == #(t:get_successors(j)))
